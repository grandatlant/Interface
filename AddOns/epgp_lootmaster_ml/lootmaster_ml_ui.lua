...
local sstScrollCols = {
       ...
       { ["name"] = "Response",		    ["width"] = 210, ["align"] = "LEFT", 	  ["defaultsort"] = "desc", ["sort"] = "desc", ["color"] = {["r"] = 0.25, ["g"] = 1.00, ["b"] = 0.25, ["a"] = 1.0 }, ["sortnext"]=11 }, --,
       { ["name"] = "EP",		          ["width"] = 50,  ["align"] = "RIGHT",   ["color"] = epgpColor},
       { ["name"] = "GP",		          ["width"] = 50,  ["align"] = "RIGHT",   ["color"] = epgpColor},
       { ["name"] = "PR",		          ["width"] = 50,  ["align"] = "RIGHT",   ["defaultsort"] = "asc", ["sort"] = "asc", ["sortfirst"]=11, ["sortnext"]=8, ["ident"]="PR"},
       { ["name"] = "Note",		          ["width"] = 250,  ["align"] = "LEFT",   ["color"] = {["r"] = 0.25, ["g"] = 1.00, ["b"] = 0.25, ["a"] = 1.0 }},
...
function LootMasterML:SetCellFormatted( cell, self, candidate, func )
    local value = func(self, candidate)
    return cell.text:SetText(value)
end
