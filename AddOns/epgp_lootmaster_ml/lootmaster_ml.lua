...
function LootMasterML:GetNote( player )
	...
	--local name, rank, rankIndex, level, class, zone, note, officernote, online, status, classFileName, achievementPoints, achievementRank, isMobile, canSoR, repStanding = GetGuildRosterInfo(1);
	--return note or 1
	--for i=1, GetNumGuildMembers() do 
  ...
  local lootTbl = self.lootTable[itemID]
    ...
    {   ["unitclass"]       = candidateClass,
        ...
        ["cols"] = {
		  ...
		  {["name"]       = 'Test',
          ["value"]      = self.GetNote,
          ["userDraw"]   = addon.SetCellFormatted,
          ["args"]       = {self, candidate, self.GetNote}},
