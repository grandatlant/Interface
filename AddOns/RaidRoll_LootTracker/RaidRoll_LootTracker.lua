...
-- (Use [item] to announce the itemlink)
	...
	Raid_Roll_PanelName_String =  RaidRoll_LootPanel:CreateFontString("Raid_Roll_PanelName_String" ,"ARTWORK","GameFontNormal");
	Raid_Roll_PanelName_String:SetPoint("TopLeft", RaidRoll_LootPanel, "TopLeft", 15, -150)
	Raid_Roll_PanelName_String:SetJustifyH("LEFT")
...
-- General settings
	Raid_Roll_PanelName_String =  RaidRoll_LootPanel:CreateFontString("Raid_Roll_PanelName_String" ,"ARTWORK","GameFontNormal");
	Raid_Roll_PanelName_String:SetPoint("TopLeft", RaidRoll_LootPanel, "TopLeft", 20, -180)
	Raid_Roll_PanelName_String:SetJustifyH("LEFT")
...
-- [ ] Automatically open window when loot is found
	...
	RR_AutoOpenLootWindow:SetPoint("TopLeft", RaidRoll_LootPanel, "TopLeft",  30, -200)
...
-- [ ] Receive loot messages from guild 
	...
	RR_ReceiveGuildMessages:SetPoint("TopLeft", RaidRoll_LootPanel, "TopLeft",  30, -220)
...
-- Create 5 strings and a header for the guild ranks
	...
	RR_Loot_String_MobName:SetText("Mob Name:")
	...
	RR_Loot_String_LooterName:SetText("Looter Name:")
	...
	RR_Loot_HowManyLoots:SetText("Loots:")
...
--------------------THE BUTTONS   [<<] [<]   [>] [>>]--------------------
	...
	RR_Loot_ButtonPrev:SetPoint("BottomLEFT", RR_LOOT_FRAME, "BottomLEFT", 50, 5)
	...
	RR_Loot_ButtonNext:SetPoint("BottomLEFT", RR_LOOT_FRAME, "BottomLEFT", 95, 5)
	...
	RR_Loot_ButtonLast:SetPoint("BottomLEFT", RR_LOOT_FRAME, "BottomLEFT", 140, 5)
	...
	RR_Loot_ButtonClear:SetPoint("BottomLEFT", RR_LOOT_FRAME, "BottomLEFT", 140, 25)
	RR_Loot_ButtonClear:SetText("Clear Data")
	...
	RR_Loot_LinkLootButton:SetText("Link Loot")
...
--------------------THE BUTTONS   [Announce1] [Announce2] [Raid Roll]--------------------
	for i=1,4 do
		...
		RR_Loot_Announce2Button:SetWidth(50)
		RR_Loot_Announce2Button:SetHeight(18)
		RR_Loot_Announce2Button:SetPoint("TopLEFT", RR_LOOT_FRAME, "TopLEFT", 105, -48 - ((i-1) * 45))
		RR_Loot_Announce2Button:SetText("Msg2")
...
--------------------------------------------------------------------------------------------------------
	...
	RR_Loot_CurrentVsMaxWindow:SetPoint("BottomLEFT",RR_LOOT_FRAME,"BottomLEFT", 160, 12);
...
function RaidRoll_Loot_Slider_Window_Scroll(direction)
	...
	if RaidRoll_DB["Loot"]["TOTAL WINDOWS"] ~= 0 then
		...
		RaidRoll_Loot_Slider:SetValue(RaidRoll_Loot_Slider:GetValue() - (direction * 2))
...
Current_Window = RaidRoll_DB["Loot"]["CURRENT WINDOW"]
Total_Windows = RaidRoll_DB["Loot"]["TOTAL WINDOWS"]
	...
	--Get the mob id for the current window
		...
		for i=1,4 do
			...
			--Get the slider offset
				...
				MobName		= RaidRoll_DB["Loot"][Current_Window]["MOB NAME"]
				LooterName	= RaidRoll_DB["Loot"][Current_Window]["LOOTER NAME"]
				
				if RaidRoll_DB["Loot"][Current_Window]["ITEM_"..j] == nil then RaidRoll_DB["Loot"][Current_Window]["ITEM_"..j] = {} end
				ItemLink 	= RaidRoll_DB["Loot"][Current_Window]["ITEM_"..j]["ITEMLINK"]
				ItemIcon 	= RaidRoll_DB["Loot"][Current_Window]["ITEM_"..j]["ICON"]
				Winner 		= RaidRoll_DB["Loot"][Current_Window]["ITEM_"..j]["WINNER"]
				Received 	= RaidRoll_DB["Loot"][Current_Window]["ITEM_"..j]["RECEIVED"]
				...
				RR_Loot_String_MobName:SetText("Mob Name: ".. MobName)
				RR_Loot_String_LooterName:SetText("Looter Name: ".. LooterName)
				
				RR_Loot_CurrentVsMaxWindow:SetText(RaidRoll_DB["Loot"]["CURRENT WINDOW"].."/"..RaidRoll_DB["Loot"]["TOTAL WINDOWS"])
				RR_Loot_HowManyLoots:SetText("Loots: " .. RaidRoll_DB["Loot"][Current_Window]["TOTAL ITEMS"])
			else
				_G["RR_Loot_LootID_String"..i]:SetText("")
...
function RR_LinkLoot()
	if RaidRoll_DB["Loot"]["CURRENT WINDOW"] 	~= nil then
		...
		if Name ~= nil then
			SendChatMessage("Displaying Loots for "..Name, rr_AnnounceType)
...
function RR_LootButton(Whatbutton)
	...
	if AnnounceType == "Announce" then
		ItemLink = RaidRoll_DB["Loot"][Current_Window]["ITEM_"..ItemID]["ITEMLINK"]
		
		AnnounceMessage,Channel = RR_AnnounceMsg(ID, ItemLink)
		
		SendChatMessage(AnnounceMessage, Channel)
	else
		RR_Command(RaidRoll_DB["Loot"][Current_Window]["ITEM_"..ID]["ITEMLINK"])
	end
end 
...
function RR_MouseOverButton(Whatbutton)
	...
	if AnnounceType == "Announce" then
		...
		ItemLink = RaidRoll_DB["Loot"][Current_Window]["ITEM_"..ID]["ITEMLINK"]
